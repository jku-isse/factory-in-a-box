...
public class PlotRequest extends AbstractMethodInvocationHandler {
	...
	public static final Argument RESPONSE = new Argument("plot response", Identifiers.String, ValueRanks.Scalar, null,
	...
	public static final Argument IMAGE_ID = new Argument(
			WellknownPlotterCapability.PLOTTING_CAPABILITY_INPUT_IMAGE_VAR_NAME, Identifiers.String, ValueRanks.Scalar,
			null, new LocalizedText("ImageId that should be plotted"));
