...
*/
	...
	public final static native long ServerAPIBase_createServerDefaultConfig(long jarg1, ServerAPIBase jarg1_);

	public final static native long ServerAPIBase_createServer(long jarg1, ServerAPIBase jarg1_, int jarg2,
			String jarg3);

	public final static native long ServerAPIBase_runServer(long jarg1, ServerAPIBase jarg1_, long jarg2);

	public final static native void ServerAPIBase_addMonitoredItem(long jarg1, ServerAPIBase jarg1_, long jarg2,
			long jarg3, UA_NodeId jarg3_, long jarg4, ServerAPIBase jarg4_);

	public final static native long ServerAPIBase_addObject(long jarg1, ServerAPIBase jarg1_, long jarg2, String jarg3);

	public final static native long ServerAPIBase_addVariableNode(long jarg1, ServerAPIBase jarg1_, long jarg2,
			long jarg3, UA_NodeId jarg3_, String jarg4, int jarg5, int jarg6);
	...
	public final static native int ServerAPIBase_writeVariable__SWIG_0(long jarg1, ServerAPIBase jarg1_, long jarg2,
			long jarg3, UA_NodeId jarg3_, int jarg4);

	public final static native int ServerAPIBase_writeVariable__SWIG_1(long jarg1, ServerAPIBase jarg1_, long jarg2,
			long jarg3, UA_NodeId jarg3_, String jarg4);

	public final static native int ServerAPIBase_writeVariable__SWIG_2(long jarg1, ServerAPIBase jarg1_, long jarg2,
			long jarg3, UA_NodeId jarg3_, double jarg4);

	public final static native long ServerAPIBase_getDataTypeNode(long jarg1, ServerAPIBase jarg1_, int jarg2);

	public final static native void ServerAPIBase_addMethod(long jarg1, ServerAPIBase jarg1_, long jarg2, long jarg3,
			UA_Argument jarg3_, long jarg4, UA_Argument jarg4_, long jarg5, UA_MethodAttributes jarg5_, long jarg6,
			ServerAPIBase jarg6_);
	...
	public final static native void ServerAPIBase_monitored_itemChanged(long jarg1, ServerAPIBase jarg1_, long jarg2,
			UA_NodeId jarg2_, int jarg3);

	public final static native void ServerAPIBase_monitored_itemChangedSwigExplicitServerAPIBase(long jarg1,
			ServerAPIBase jarg1_, long jarg2, UA_NodeId jarg2_, int jarg3);

	public final static native void ServerAPIBase_methods_callback(long jarg1, ServerAPIBase jarg1_, long jarg2,
			ServerAPIBase jarg2_, long jarg3, UA_NodeId jarg3_, long jarg4, UA_NodeId jarg4_, String jarg5,
			String jarg6);

	public final static native void ServerAPIBase_methods_callbackSwigExplicitServerAPIBase(long jarg1,
			ServerAPIBase jarg1_, long jarg2, ServerAPIBase jarg2_, long jarg3, UA_NodeId jarg3_, long jarg4,
			UA_NodeId jarg4_, String jarg5, String jarg6);

	public final static native void delete_ServerAPIBase(long jarg1);

	public final static native long new_ServerAPIBase();

	public final static native void ServerAPIBase_director_connect(ServerAPIBase obj, long cptr, boolean mem_own,
			boolean weak_global);

	public final static native void ServerAPIBase_change_ownership(ServerAPIBase obj, long cptr,
			boolean take_or_release);

	public final static native void ClientAPIBase_current_nodeId_set(long jarg1, ClientAPIBase jarg1_, long jarg2,
			UA_NodeId jarg2_);
	...
	public final static native int ClientAPIBase_clientConnect(long jarg1, ClientAPIBase jarg1_, long jarg2,
			String jarg3);
	...
	public final static native int ClientAPIBase_clientSubtoNode(long jarg1, ClientAPIBase jarg1_, long jarg2,
			long jarg3, UA_NodeId jarg3_);

	public final static native void ClientAPIBase_clientRemoveSub(long jarg1, int jarg2);

	public final static native int ClientAPIBase_clientReadValue(long jarg1, long jarg2, UA_NodeId jarg2_);

	public final static native int ClientAPIBase_clientWriteValue(long jarg1, long jarg2, UA_NodeId jarg2_, int jarg3);

	public final static native void ClientAPIBase_monitored_itemChanged(long jarg1, ClientAPIBase jarg1_, long jarg2,
			UA_NodeId jarg2_, int jarg3);

	public final static native void ClientAPIBase_monitored_itemChangedSwigExplicitClientAPIBase(long jarg1,
			ClientAPIBase jarg1_, long jarg2, UA_NodeId jarg2_, int jarg3);

	public final static native void ClientAPIBase_client_connected(long jarg1, ClientAPIBase jarg1_, long jarg2,
			ClientAPIBase jarg2_, long jarg3, String jarg4);

	public final static native void ClientAPIBase_client_connectedSwigExplicitClientAPIBase(long jarg1,
			ClientAPIBase jarg1_, long jarg2, ClientAPIBase jarg2_, long jarg3, String jarg4);

	public final static native void delete_ClientAPIBase(long jarg1);

	public final static native long new_ClientAPIBase();

	public final static native void ClientAPIBase_director_connect(ClientAPIBase obj, long cptr, boolean mem_own,
			boolean weak_global);

	public final static native void ClientAPIBase_change_ownership(ClientAPIBase obj, long cptr,
			boolean take_or_release);
	...
	public final static native void UA_Argument_dataType_set(long jarg1, UA_Argument jarg1_, long jarg2,
			UA_NodeId jarg2_);
	...
	public final static native void UA_Argument_description_set(long jarg1, UA_Argument jarg1_, long jarg2,
			UA_LocalizedText jarg2_);
	...
	public final static native void UA_MethodAttributes_specifiedAttributes_set(long jarg1, UA_MethodAttributes jarg1_,
			int jarg2);

	public final static native int UA_MethodAttributes_specifiedAttributes_get(long jarg1, UA_MethodAttributes jarg1_);

	public final static native void UA_MethodAttributes_displayName_set(long jarg1, UA_MethodAttributes jarg1_,
			long jarg2, UA_LocalizedText jarg2_);

	public final static native long UA_MethodAttributes_displayName_get(long jarg1, UA_MethodAttributes jarg1_);

	public final static native void UA_MethodAttributes_description_set(long jarg1, UA_MethodAttributes jarg1_,
			long jarg2, UA_LocalizedText jarg2_);

	public final static native long UA_MethodAttributes_description_get(long jarg1, UA_MethodAttributes jarg1_);

	public final static native void UA_MethodAttributes_writeMask_set(long jarg1, UA_MethodAttributes jarg1_,
			int jarg2);

	public final static native int UA_MethodAttributes_writeMask_get(long jarg1, UA_MethodAttributes jarg1_);

	public final static native void UA_MethodAttributes_userWriteMask_set(long jarg1, UA_MethodAttributes jarg1_,
			int jarg2);

	public final static native int UA_MethodAttributes_userWriteMask_get(long jarg1, UA_MethodAttributes jarg1_);

	public final static native void UA_MethodAttributes_executable_set(long jarg1, UA_MethodAttributes jarg1_,
			boolean jarg2);

	public final static native boolean UA_MethodAttributes_executable_get(long jarg1, UA_MethodAttributes jarg1_);

	public final static native void UA_MethodAttributes_userExecutable_set(long jarg1, UA_MethodAttributes jarg1_,
			boolean jarg2);
	...
	public static void SwigDirector_ServerAPIBase_methods_callback(ServerAPIBase jself, long jAPIBase, long methodId,
			long objectId, String input, String output) {
		jself.methods_callback((jAPIBase == 0) ? null : new ServerAPIBase(jAPIBase, false),
				(methodId == 0) ? null : new UA_NodeId(methodId, false),
				(objectId == 0) ? null : new UA_NodeId(objectId, false), input, output);
	}
	...
	public static void SwigDirector_ClientAPIBase_client_connected(ClientAPIBase jself, long jClientAPIBase,
			long client, String serverUrl) {
		jself.client_connected((jClientAPIBase == 0) ? null : new ClientAPIBase(jClientAPIBase, false),
				(client == 0) ? null : new SWIGTYPE_p_UA_Client(client, false), serverUrl);
	}
