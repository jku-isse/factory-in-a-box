...
//									"RemoteRole1");
		WiringInfo newWI = new WiringInfo("EAST_CLIENT",
				"DefaultHandshakeServerSide",
		...
		String newCapToWire = "EAST_CLIENT";
		try {			
			new BackwiringUtil().removeWireFromAndAddInfoTo(endpointUrl, "NORTH_CLIENT", endpointUrl, newCapToWire, newWI);			
		} catch (Exception e) {			
			e.printStackTrace();
		}		
