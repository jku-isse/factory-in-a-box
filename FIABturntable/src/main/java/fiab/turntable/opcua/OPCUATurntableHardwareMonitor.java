...
public class OPCUATurntableHardwareMonitor extends AbstractActor {
    ...
    public static Props props(OPCUABase opcuaBase, UaFolderNode ttNode, String fuPrefix, HardwareInfo hardwareInfo) {
        return Props.create(OPCUATurntableHardwareMonitor.class, () -> new OPCUATurntableHardwareMonitor(opcuaBase, ttNode, fuPrefix, hardwareInfo));
    }

    public OPCUATurntableHardwareMonitor(OPCUABase opcuaBase, UaFolderNode ttNode, String fuPrefix, HardwareInfo hardwareInfo) {
