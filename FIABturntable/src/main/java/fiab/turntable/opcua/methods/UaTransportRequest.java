...
public class UaTransportRequest extends AbstractMethodInvocationHandler {
    ...
    public static final Argument RESPONSE = new Argument(
            ...
            ValueRanks.Scalar,
            null,
            new LocalizedText("Response indicating (new) state of Transportmoduel whether transport request can be fulfilled.")
        );  
    
    public static final Argument CAP_FROM = new Argument(
            "cap from",
            Identifiers.String,
            ValueRanks.Scalar,
            null,
    ...
    public static final Argument CAP_TO = new Argument(
            "cap to",
            Identifiers.String,
            ValueRanks.Scalar,
            null,
    ...
    public static final Argument ORDERID = new Argument(
            "order id",
            Identifiers.String,
            ValueRanks.Scalar,
            null,
    ...
    public static final Argument REQID = new Argument(
            "request id",
            Identifiers.String,
            ValueRanks.Scalar,
            null,
    ...
    public UaTransportRequest(UaMethodNode methodNode, ActorRef actor) {
        super(methodNode); 
        this.actor = actor;        
    }
