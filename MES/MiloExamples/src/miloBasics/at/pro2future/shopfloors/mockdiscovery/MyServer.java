...
package miloBasics.at.pro2future.shopfloors.mockdiscovery;
...
private boolean running = true;
    ...
    public static void main(String[] args) throws Exception {
    	...
    	ApplicationDescription desc = server.getServer().getApplicationDescription();
    	if(hasEndpoint) {
    		...
    		System.out.println("Could not setup Server Endpoints");
    	}
    	...
    	while((Integer)server.execs.getValue() < 6000) {
    ...
    public MyServer() throws Exception {
        ...
        String applicationUri = certificateManager.getCertificates().stream()
            ...
            .orElse("urn:at:pro2future:shopfloors:helloworld:" + UUID.randomUUID());

        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
            .setApplicationUri(applicationUri)
            .setApplicationName(LocalizedText.english("English Hello World Server"))
            ...
            .setBuildInfo(
                new BuildInfo(
                    "urn:at:pro2future:shopfloors:helloworld",
                    "eclipse",
                    "English Hello World Server",
                    OpcUaServer.SDK_VERSION,
                    "", DateTime.now()))
            .setCertificateManager(certificateManager)
            .setCertificateValidator(certificateValidator)
            .setIdentityValidator(new CompositeValidator(identityValidator, x509IdentityValidator))
            .setProductUri("urn:at:pro2future:shopfloors:helloworld")
            .setServerName("EnglishHelloWorld")
            .setSecurityPolicies(
                EnumSet.of(
                    SecurityPolicy.None,
