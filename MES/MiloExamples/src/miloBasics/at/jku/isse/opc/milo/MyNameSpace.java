...
import miloBasics.org.eclipse.milo.examples.server.types.CustomDataType;
...
public class MyNameSpace implements Namespace {
    ...
    private static final Object[][] STATIC_SCALAR_NODES = new Object[][]{
        ...
        {"MaxCustomNode", Identifiers.String, new Variant("startValue")},
        ...
        {"motor.currentSpeed", Identifiers.Double , new Variant(1.0d)},
        {"motor.targetSpeed", Identifiers.Double , new Variant(3.1415d)}
    };
    ...
    public MyNameSpace(OpcUaServer server, UShort namespaceIndex) {
        ...
        try {
            ...
            NodeId folderNodeId = new NodeId(namespaceIndex, "It's MAX WORLD"); //TODO change back to HelloWorld
    ...
    private void addHelloWorldNode(UaFolderNode folderNode) {
        ...
        try {
            AnnotationBasedInvocationHandler invocationHandler =
                AnnotationBasedInvocationHandler.fromAnnotatedObject(
                    server.getNodeMap(), new HelloWorldMethod());
