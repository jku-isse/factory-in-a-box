...
private boolean running = true;
    ...
    public static void main(String[] args) throws Exception {
    	MyServer server = new MyServer("staticServerCreation", 12686);
    ...
    public MyServer(String serverName, int serverPort) throws Exception {
        ...
        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
            ...
            .setBindPort(serverPort) //12686 / 4840
            ...
            .build();
        System.out.println("application uri" + applicationUri); //TODO remove
        for(String s: endpointAddresses) { System.out.println("adress: " + s);}
