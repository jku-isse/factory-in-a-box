...
//			statusIOS = generateStateVariableNode(handshakeNode, machineName +"/HANDSHAKE_FU", IOStationCapability.STATE_VAR_NAME, ServerSideStates.STOPPED);
//		}
//		statusHS = generateStateVariableNode(handshakeNode, machineName +"/HANDSHAKE_FU", IOStationCapability.OPCUA_STATE_SERVERSIDE_VAR_NAME, ServerSideStates.STOPPED); 
//	}
//
//	
//
