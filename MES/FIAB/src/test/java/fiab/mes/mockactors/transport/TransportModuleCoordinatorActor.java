...
public class TransportModuleCoordinatorActor extends AbstractActor{
	...
	protected TurningStates ttFUState;
	...
	static public Props props(InterMachineEventBus internalMachineEventBus, ActorRef turntableFU) {	    
		return Props.create(TransportModuleCoordinatorActor.class, () -> new TransportModuleCoordinatorActor(internalMachineEventBus, turntableFU));
	}
	
	public TransportModuleCoordinatorActor(InterMachineEventBus machineEventBus, ActorRef turntableFU) {
...
//				})
				...
				.match(TurningStates.class, state -> {
					ttFUState = state;
					switch(state) {								
					case COMPLETING:
