...
public class ProduceProcess {
	...
	public static ProcessCore.Process getDemoProcess(String prefix, XmlRoot root, SupportedColors... colors) {
		...
		for (SupportedColors color : colors) {
			...
			s1.getInputMappings()
					.add(EcoreProcessUtils.getVariableMapping(root.getCapabilities().get(count).getInputs().get(0)));
	...
	public static ProcessCore.Process getSequential4ColorProcess(String prefix, XmlRoot root) {
		...
		s1.getInputMappings()
				.add(EcoreProcessUtils.getVariableMapping(root.getCapabilities().get(0).getInputs().get(0)));
		s2.getInputMappings()
				.add(EcoreProcessUtils.getVariableMapping(root.getCapabilities().get(1).getInputs().get(0)));
		s3.getInputMappings()
				.add(EcoreProcessUtils.getVariableMapping(root.getCapabilities().get(2).getInputs().get(0)));
		s4.getInputMappings()
				.add(EcoreProcessUtils.getVariableMapping(root.getCapabilities().get(3).getInputs().get(0)));
