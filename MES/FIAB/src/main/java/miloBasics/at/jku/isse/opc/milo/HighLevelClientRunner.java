...
import miloBasics.org.eclipse.milo.examples.server.ExampleServer;

import static org.eclipse.milo.opcua.stack.core.types.builtin.unsigned.Unsigned.uint;

public class HighLevelClientRunner {
    ...
    public HighLevelClientRunner(Client clientExample) throws Exception {
        this(clientExample, false);
    }

    public HighLevelClientRunner(Client clientExample, boolean serverRequired) throws Exception {
    ...
    private OpcUaClient createClient() throws Exception {
        File securityTempDir = new File(System.getProperty("java.io.tmpdir"), "securityTwo");
