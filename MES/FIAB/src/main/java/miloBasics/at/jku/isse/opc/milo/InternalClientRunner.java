...
public class InternalClientRunner implements Runnable{
    ...
    public InternalClientRunner(Client clientExample) throws Exception {
        this(clientExample, false);
    }

    public InternalClientRunner(Client clientExample, boolean serverRequired) throws Exception {
