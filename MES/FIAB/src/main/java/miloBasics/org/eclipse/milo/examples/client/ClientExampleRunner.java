...
package miloBasics.org.eclipse.milo.examples.client;
...
//    }
	...
	public ClientExampleRunner(ClientExample clientExample, boolean serverRequired, List<String> nodes)
			throws Exception {
	...
	private OpcUaClient createClient() throws Exception {
		...
		OpcUaClientConfig config = OpcUaClientConfig.builder()
				...
				.setIdentityProvider(clientExample.getIdentityProvider()).setRequestTimeout(uint(5000)).build();
