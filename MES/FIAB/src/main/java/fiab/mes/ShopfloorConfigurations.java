...
import fiab.mes.transport.actor.bufferstation.wrapper.LocalBufferStationActorSpawner;
...
//	}
    ...
    public static void addBufferStationSpawner(Map<AbstractMap.SimpleEntry<String, ProvOrReq>, CapabilityCentricActorSpawnerInterface> cap2URISpawning) {
        cap2URISpawning.put(new AbstractMap.SimpleEntry<String, CapabilityImplementationMetadata.ProvOrReq>(BufferStationWellKnownCapabilityIdentifiers.BUFFER_CAPABILITY_URI, ProvOrReq.PROVIDED),
                new CapabilityCentricActorSpawnerInterface() {
                    @Override
                    public ActorRef createActorSpawner(ActorContext context) {
                        return context.actorOf(LocalBufferStationActorSpawner.props());
                    }
                });
    }
}
