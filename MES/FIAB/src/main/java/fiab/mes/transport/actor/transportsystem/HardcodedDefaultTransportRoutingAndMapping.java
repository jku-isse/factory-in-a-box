...
import fiab.mes.transport.actor.transportmodule.WellknownTransportModuleCapabilityInstanceIds;
...
public class HardcodedDefaultTransportRoutingAndMapping implements TransportRoutingInterface, InternalCapabilityToPositionMapping {
	...
	private void setupHardcodedCapabilityToPositionMapping() {
		tt20map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_EAST_CLIENT, pos21);
		tt20map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_WEST_CLIENT, pos34);
		tt20map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_SOUTH_CLIENT, pos37);
		tt20map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_NORTH_CLIENT, pos31);
		tt20map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_SELF, pos20);
		tt21map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_EAST_CLIENT, pos35);
		tt21map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_WEST_SERVER, pos20);
		tt21map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_SOUTH_CLIENT, pos38);
		tt21map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_NORTH_CLIENT, pos32);
		tt21map.put(WellknownTransportModuleCapabilityInstanceIds.TRANSPORT_MODULE_SELF, pos21);
