...
public class AdaptedCapabilityDiscoveryActor extends AbstractActor {
	...
	public static class BrowseRequest {
		String endpointURL;
		Map<SimpleEntry<String, ProvOrReq>, CapabilityCentricActorSpawnerInterface> capURI2Spawning;

		public BrowseRequest(String endpointURL, Map<SimpleEntry<String, ProvOrReq>, CapabilityCentricActorSpawnerInterface> capURI2Spawning) {
			super();
	...
	static public Props props() {
		return Props.create(AdaptedCapabilityDiscoveryActor.class, () -> new AdaptedCapabilityDiscoveryActor());
	}

	public AdaptedCapabilityDiscoveryActor() {
		this.self = getSelf();
	}
			...
			if (n.getNodeClass().equals(NodeClass.Object)) {
				if (isCapabilityFolder(n)) {
					try {
						...
						SimpleEntry<String, ProvOrReq> foundEntry = new SimpleEntry<String, ProvOrReq>(capMeta.getCapabilityURI(), capMeta.getProvOrReq());
