...
public class VirtualPlotterFactory {
     ...
     */
    public static ParticipantInfo initPlotterAndReturnInfo(ActorSystem system, String machineId, Map<String, TransportRoutingInterface.Position> positionMap) {
        int opcUaPort = PortUtils.findNextFreePort();
        TransportRoutingInterface.Position position = positionMap.getOrDefault(machineId, TransportRoutingInterface.UNKNOWN_POSITION);
