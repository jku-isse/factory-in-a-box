...
public class ClientSideHandshakeFU implements StatePublisher, HandshakeFU, WiringUpdateInterface {
    ...
    private void setupOPCUANodeSet() {
        ...
        // add wiring method
        wiringNodes = WiringExposingUtils.createWiringInfoFolder(base, wiringsFolder, wiringsFolderPath);
        org.eclipse.milo.opcua.sdk.server.nodes.UaMethodNode nWire = base.createPartialMethodNode(path, OPCUACapabilitiesAndWiringInfoBrowsenames.OPCUA_WIRING_REQUEST, "Request wiring");
